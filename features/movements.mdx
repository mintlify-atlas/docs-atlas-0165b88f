---
title: "Spontaneous, Fixed, and Pending Movements in Leo Counter"
sidebarTitle: "Movements"
description: "Leo Counter tracks spontaneous, fixed recurring, and pending movements. Each type supports file attachments and integrates with accounts and categories."
---
...
<Tabs>
  <Tab title="Spontaneous">
    ...
    **Base route:** `/movimientos-espontaneos`
    ...
    <ParamField body="comprobantes_existing" type="array">
      Array of attachment IDs to retain from the previous version of the movement.
    </ParamField>
    <ParamField body="comprobantes_delete_ids" type="array">
  ...
  <Tab title="Fixed / Recurring">
    ...
    **Base route:** `/movimientos-fijos`
    ...
    <ParamField body="registrar_automatico" type="boolean">
